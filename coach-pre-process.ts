...
/**
 * Usage:
 *   deno run -A coach-pre-process.ts
 * 
 ...
 * - If the file is managed by chezmoi find text "To modify, use `chezmoi edit ~/coach-pre-process.ts --apply`."
...
import { relative } from "https://deno.land/std@0.212.0/path/mod.ts";
