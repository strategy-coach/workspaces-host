function fish_greeting
    ...
    if test -z "$fgKeyValue"
        ...
        set_color --dim
        chezmoi git pull -- --autostash --rebase && chezmoi status
        set_color normal
    end
end
